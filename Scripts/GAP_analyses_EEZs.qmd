...
# Save ecoregion map
ggsave(here("Results", "ecoregion_NT_coverage_map.png"), eco_map, width = 12, height = 8, dpi = 300)
...
ggsave(here("Results", "top_ecoregions_NT_coverage.png"), top_eco_plot, width = 10, height = 8, dpi = 300)
