...
# Save the combined plot
ggsave(here::here("combined_violin_plots.png"), combined_plot, width = 12, height = 6, units = "in")
...
gam_density_plot_FUSE_03 <- ggplot(plot_data, aes(x = A1, y = A2, z = predicted_FUSE_03)) +
  stat_summary_2d(fun = mean, bins = 50) +
  scale_fill_viridis_c(name = "Predicted FUSE 03 Protection") +
  theme_minimal() +
  labs(title = "GAM Predictions: FUSE 03 Protection",
       x = "Trait Axis 1",
       y = "Trait Axis 2")
...
gam_density_plot_FUSE_01 <- ggplot(plot_data, aes(x = A1, y = A2, z = predicted_FUSE_01)) +
  stat_summary_2d(fun = mean, bins = 50) +
  scale_fill_viridis_c(name = "Predicted FUSE 01 Protection") +
  theme_minimal() +
  labs(title = "GAM Predictions: FUSE 01 Protection",
       x = "Trait Axis 1",
       y = "Trait Axis 2")
...
# Then combine them using patchwork:
library(patchwork)
combined_plot <- (gam_density_plot_GAP_all_MPAs + gam_density_plot_FUSE_01 + gam_density_plot_FUSE_03) +
  plot_annotation(tag_levels = 'A')

# Save the combined plot
ggsave(here::here("combined_functional_spaces_with_predictions.png"), combined_plot, width = 12*2, height = 6, units = "in")
