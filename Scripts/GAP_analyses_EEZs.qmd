...
violin_plot_with_significance_all <- violin_plot +
...
# Add significance bars and labels
violin_plot_with_significance_nt <- violin_plot +
  geom_segment(data = significant_comparisons,
               aes(x = x1, xend = x2, y = y.position, yend = y.position),
               inherit.aes = FALSE,
               color = "black", size = 0.5) +
...
results_IUCN <- left_join(IUCN, combined_protection_FUSE_03, by=c("species" = "species_name"))
...
# Add significance bars and labels
violin_plot_with_significance_FUSE_03 <- violin_plot_FUSE +
  geom_segment(data = significant_comparisons,
               aes(x = x1, xend = x2, y = y.position, yend = y.position),
               inherit.aes = FALSE,
               color = "black", size = 0.5) +
...
results_IUCN <- left_join(IUCN, combined_protection_FUSE_01, by=c("species" = "species_name"))
