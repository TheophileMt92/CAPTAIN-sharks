...
# Create the individual plots
continental_bivariate <- create_bivariate_plot(continental_sf)
highseas_bivariate <- create_bivariate_plot(highseas_sf)

# Create the continental figure with legend
continental_layout <- rbind(
  c(1, 1, 1),
  c(1, 1, 1),
  c(1, 1, 1),
  c(2, 2, 2)
...
continental_with_legend <- grid.arrange(
  continental_bivariate,
  legend_plot,
  layout_matrix = continental_layout,
  heights = c(0.3, 0.3, 0.3, 0.2)
)

# Save the continental figure
ggsave(here::here("continental_bivariate_map_03.png"), 
       continental_with_legend,
       width = 10, 
       height = 10,
       dpi = 300,
       bg = "white")
...
highseas_with_legend <- grid.arrange(
  highseas_bivariate,
  legend_plot,
  layout_matrix = highseas_layout,
  heights = c(0.3, 0.3, 0.3, 0.2)
)

# Save the high seas figure
ggsave(here::here("highseas_bivariate_map_03.png"), 
       highseas_with_legend,
       width = 10, 
       height = 10,
       dpi = 300,
       bg = "white")
...
# Save the continental figure
ggsave(here::here("continental_bivariate_map_budget01.png"), 
       continental_with_legend,
       width = 10, 
       height = 10,
       dpi = 300,
...
# Save the high seas figure
ggsave(here::here("highseas_bivariate_map_budget01.png"), 
       highseas_with_legend,
       width = 10, 
       height = 10,
       dpi = 300,
