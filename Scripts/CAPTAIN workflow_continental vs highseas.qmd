...
#sp_in_data <- global_species_lookup
...
combined_protection_FUSE_03 <- full_join(
  continental_prot_frac %>% 
    dplyr::select(sp, species_name, Mean_Protect_Fraction) %>%
...
# Add FUSE scores
combined_protection_FUSE_03 <- left_join(combined_protection_FUSE_03, species_FUSE_map, by = c("species_name" = "Species"))

# Create summary statistics
summary_stats <- combined_protection_FUSE_03 %>%
  dplyr::select(-species_name) %>%  # Remove the species name column as it's not numerical
...
hist_fuse <- ggplot(combined_protection_FUSE_03, aes(x = FUSE.x)) +
  geom_histogram(binwidth = 0.05, fill = "lightgreen", color = "black") +
  theme_minimal() +
  labs(title = "Histogram of FUSE Scores",
       x = "FUSE Score",
...
scatter_plot <- ggplot(combined_protection_FUSE_03, aes(x = FUSE.x, y = weighted_protection)) +
  geom_point(alpha = 0.6, color = "darkblue") +
  theme_minimal() +
  scale_y_continuous(limits=c(0,1)) + 
...
# Add FUSE scores
combined_protection_FUSE_01 <- left_join(combined_protection_FUSE_01, species_FUSE_map, by = c("species_name" = "Species"))
...
hist_fuse <- ggplot(combined_protection_FUSE_01, aes(x = FUSE.x)) +
  geom_histogram(binwidth = 0.05, fill = "lightgreen", color = "black") +
  theme_minimal() +
  labs(title = "Histogram of FUSE Scores",
       x = "FUSE Score",
...
scatter_plot <- ggplot(combined_protection_FUSE_01, aes(x = FUSE.x, y = weighted_protection)) +
  geom_point(alpha = 0.6, color = "darkblue") +
  theme_minimal() +
  scale_y_continuous(limits=c(0,1)) + 
  labs(title = "Scatterplot: FUSE vs Weighted Protection Fraction (Combined)",
...
# Combine the protection fractions with range sizes
combined_protection_EDGE_03 <- full_join(
  continental_prot_frac %>% 
    dplyr::select(sp, species_name, Mean_Protect_Fraction) %>%
    rename(continental_protection = Mean_Protect_Fraction),
  highseas_prot_frac %>% 
...
# Add EDGE2 scores
combined_protection_EDGE_03 <- left_join(combined_protection_EDGE_03, species_EDGE2_map, by = c("species_name" = "Species"))

# Create summary statistics
summary_stats <- combined_protection_EDGE_03 %>%
  dplyr::select(-species_name) %>%  # Remove the species name column as it's not numerical
  summarise(across(everything(), list(
    min = ~min(., na.rm = TRUE),
    q1 = ~quantile(., 0.25, na.rm = TRUE),
...
# Create visualizations
hist_protect <- ggplot(combined_protection_EDGE_03, aes(x = weighted_protection)) +
  geom_histogram(binwidth = 0.05, fill = "skyblue", color = "black") +
  scale_x_continuous(limits=c(0,1)) + 
  theme_minimal() +
  labs(title = "Histogram of Range-Weighted Protection \nFraction (Combined)",
...
hist_EDGE2 <- ggplot(combined_protection_EDGE_03, aes(x = EDGE2.x)) +
  geom_histogram(binwidth = 0.05, fill = "lightgreen", color = "black") +
  theme_minimal() +
  labs(title = "Histogram of EDGE2 Scores",
       x = "EDGE2 Score",
...
scatter_plot <- ggplot(combined_protection_EDGE_03, aes(x = EDGE2.x, y = weighted_protection)) +
  geom_point(alpha = 0.6, color = "darkblue") +
  theme_minimal() +
  scale_y_continuous(limits=c(0,1)) + 
...
# Create species range type summary
range_type_summary <- combined_protection_EDGE_03 %>%
  summarise(
    total_species = n(),
    continental_only = sum(highseas_range == 0 & continental_range > 0),
    highseas_only = sum(continental_range == 0 & highseas_range > 0),
...
# Save the combined protection data
saveRDS(combined_protection_EDGE_03, file = here::here("Data", "combined_protection_EDGE_03.rds"))
```
...
# Combine the protection fractions with range sizes
combined_protection_EDGE_01 <- full_join(
  continental_prot_frac %>% 
    dplyr::select(sp, species_name, Mean_Protect_Fraction) %>%
    rename(continental_protection = Mean_Protect_Fraction),
  highseas_prot_frac %>% 
...
# Add EDGE2 scores
combined_protection_EDGE_01 <- left_join(combined_protection_EDGE_01, species_EDGE2_map, by = c("species_name" = "Species"))

# Create summary statistics
summary_stats <- combined_protection_EDGE_01 %>%
  dplyr::select(-species_name) %>%  # Remove the species name column as it's not numerical
  summarise(across(everything(), list(
    min = ~min(., na.rm = TRUE),
    q1 = ~quantile(., 0.25, na.rm = TRUE),
...
# Create visualizations
hist_protect <- ggplot(combined_protection_EDGE_01, aes(x = weighted_protection)) +
  geom_histogram(binwidth = 0.05, fill = "skyblue", color = "black") +
  scale_x_continuous(limits=c(0,1)) + 
  theme_minimal() +
  labs(title = "Histogram of Range-Weighted Protection \nFraction (Combined)",
...
hist_EDGE2 <- ggplot(combined_protection_EDGE_01, aes(x = EDGE2.x)) +
  geom_histogram(binwidth = 0.05, fill = "lightgreen", color = "black") +
  theme_minimal() +
  labs(title = "Histogram of EDGE2 Scores",
       x = "EDGE2 Score",
...
scatter_plot <- ggplot(combined_protection_EDGE_01, aes(x = EDGE2.x, y = weighted_protection)) +
  geom_point(alpha = 0.6, color = "darkblue") +
  theme_minimal() +
  scale_y_continuous(limits=c(0,1)) + 
  labs(title = "Scatterplot: EDGE2 vs Weighted Protection Fraction (Combined)",
...
# Create species range type summary
range_type_summary <- combined_protection_EDGE_01 %>%
  summarise(
    total_species = n(),
    continental_only = sum(highseas_range == 0 & continental_range > 0),
    highseas_only = sum(continental_range == 0 & highseas_range > 0),
...
# Save the combined protection data
saveRDS(combined_protection_EDGE_01, file = here::here("Data", "combined_protection_EDGE_01.rds"))
```