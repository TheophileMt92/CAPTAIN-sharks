...
p100_vs_fuse_continental_plot_labeled <- add_panel_labels(p100_vs_fuse_continental_plot, "D")
p100_vs_edge2_continental_plot_labeled <- add_panel_labels(p100_vs_edge2_continental_plot, "E")
difference_plot_FUSE_EDGE2_01_continental_labeled <- add_panel_labels(difference_plot_FUSE_EDGE2_01_continental, "F")

# Combine plots into a 2x3 grid
combined_plot <- (IUCN_P100_plot_labeled + continental_plot_FUSE_01_labeled + continental_plot_EDGE2_01_labeled) /
                 (p100_vs_fuse_continental_plot_labeled + p100_vs_edge2_continental_plot_labeled +  difference_plot_FUSE_EDGE2_01_continental_labeled)

# Display the combined plot
combined_plot

# Save the combined plot if needed
ggsave(here::here("six_maps_continental_10.png"), combined_plot, width = 15, height = 10, dpi = 300)
```
